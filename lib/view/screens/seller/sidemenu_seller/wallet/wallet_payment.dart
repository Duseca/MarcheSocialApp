...
import 'package:marche_social_app/view/screens/seller/sidemenu_seller/wallet/reciept.dart';
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                Container(
                  height: 80,
                  decoration: rounded2(kBlueColor.withOpacity(0.2)),
                  child: Center(
                    child: ListTile(
                      leading: CommonImageView(
        ...
        return AlertDialog(
            ...
            content: Column(
              ...
              children: [
                ...
                CommonImageView(
                  imagePath: Assets.imagesWithdrawal,
                  height: 131,
                  fit: BoxFit.contain,
                ),
                MyText(
                ...
                MyText(
                  text:
                      'You have successfully WithDrawal of € 550 into your wallet.',
                  textAlign: TextAlign.center,
                  paddingLeft: 20,
                  paddingRight: 20,
                  paddingBottom: 20,
